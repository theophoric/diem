...
sourcesIndex["diem_config"] = {"name":"","dirs":[{"name":"config","files":["consensus_config.rs","debug_interface_config.rs","error.rs","execution_config.rs","json_rpc_config.rs","key_manager_config.rs","logger_config.rs","mempool_config.rs","mod.rs","network_config.rs","safety_rules_config.rs","secure_backend_config.rs","state_sync_config.rs","storage_config.rs","test_config.rs","upstream_config.rs"]}],"files":["generator.rs","keys.rs","lib.rs","network_id.rs","utils.rs"]};
...
sourcesIndex["diem_genesis_tool"] = {"name":"","files":["builder.rs","command.rs","config_builder.rs","fullnode_builder.rs","genesis.rs","key.rs","layout.rs","lib.rs","move_modules.rs","swarm_config.rs","validator_builder.rs","validator_config.rs","validator_operator.rs","verify.rs","waypoint.rs"]};
...
sourcesIndex["diem_vm"] = {"name":"","files":["access_path_cache.rs","adapter_common.rs","counters.rs","data_cache.rs","diem_vm.rs","diem_vm_impl.rs","errors.rs","lib.rs","logging.rs","natives.rs","script_to_script_function.rs","system_module_names.rs","transaction_metadata.rs"]};
...
sourcesIndex["move_package"] = {"name":"","dirs":[{"name":"source_package","files":["layout.rs","manifest_parser.rs","mod.rs","parsed_manifest.rs"]}],"files":["lib.rs"]};
...
sourcesIndex["network"] = {"name":"","dirs":[{"name":"connectivity_manager","files":["builder.rs","mod.rs"]},{"name":"noise","files":["error.rs","fuzzing.rs","handshake.rs","mod.rs","stream.rs"]},{"name":"peer","files":["fuzzing.rs","mod.rs"]},{"name":"peer_manager","files":["builder.rs","conn_notifs_channel.rs","error.rs","mod.rs","senders.rs","transport.rs","types.rs"]},{"name":"protocols","dirs":[{"name":"direct_send","files":["mod.rs"]},{"name":"health_checker","files":["builder.rs","mod.rs"]},{"name":"network","files":["mod.rs"]},{"name":"rpc","files":["error.rs","mod.rs"]},{"name":"wire","dirs":[{"name":"handshake","dirs":[{"name":"v1","files":["mod.rs"]}]},{"name":"messaging","dirs":[{"name":"v1","files":["mod.rs"]}]}],"files":["handshake.rs","messaging.rs","mod.rs"]}],"files":["identity.rs","mod.rs"]},{"name":"testutils","files":["fake_socket.rs","mod.rs"]},{"name":"transport","files":["mod.rs"]}],"files":["constants.rs","counters.rs","error.rs","fuzzing.rs","lib.rs","logging.rs"]};
...
sourcesIndex["smoke_test"] = {"name":"","files":["event_fetcher.rs","fullnode.rs","lib.rs","replay_tooling.rs","scripts_and_modules.rs","transaction.rs","verifying_client.rs"]};
...
sourcesIndex["testcases"] = {"name":"","files":["compatibility_test.rs","lib.rs","performance_test.rs"]};
